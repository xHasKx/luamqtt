...
--			Expecting '[mqtt[s]://][username[:password]@]hostname[:port]' format. Any option specifically added to the options
...
-- @tparam[opt] string opts.hostnamne			hostname of the MQTT broker to connect to
...
function client_mt:open_connection()
	...
	client_mt._parse_connection_opts(opts, conn)
...
function client_mt._parse_connection_opts(opts, conn)
...
if _G._TEST then
	...
	client.__parse_connection_opts = client_mt._parse_connection_opts
end
